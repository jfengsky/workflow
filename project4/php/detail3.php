...
<?php
	...
	if($_SERVER['HTTP_HOST'] == 'jfengsky.daily.taobao.net'){
        css('assets/mods/top/top','assets/mods/dpl/dpl','assets/mods/detail/top','assets/mods/detail/left','assets/mods/detail/right','assets/mods/detail/vote','assets/mods/footer/footer');
    }else{
...
<div class="detail">
	...
	<?php
	//左侧详情
    require('detail/left2.php');
	?>
	<?php
	//右侧进度条
    require('detail/right3.php');
	?>
	<?php
	//卖家投票
